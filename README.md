...
This does not only mean that users wait for a big file to download, but [as Addy Osmani points out](https://medium.com/@addyosmani/the-cost-of-javascript-in-2018-7d8950fbb5d4)
